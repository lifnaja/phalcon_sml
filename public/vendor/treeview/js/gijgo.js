...
gj.tree.methods = {
    ...
    appendNode: function ($tree, $parent, nodeData, level, position) {
        ...
        if (data.imageCssClassField && nodeData.data[data.imageCssClassField]) {
            $('<span data-role=""><span class="' + nodeData.data[data.imageCssClassField] + '"></span></span>').insertBefore($display); /* data-role="image" */
        } else if (data.imageUrlField && nodeData.data[data.imageUrlField]) {
            $span = $('<span data-role=""></span>'); /* data-role="image" */
            ...
            //$img = '<i class="fa  fa-circle-o" aria-hidden="true"></i>';
            //$img = '';
            $span.append($img);
        } else if (data.imageHtmlField && nodeData.data[data.imageHtmlField]) {
            $span = $('<span data-role="">' + nodeData.data[data.imageHtmlField] + '</span>'); /* data-role="image" */
            $span.insertBefore($display);
        }
